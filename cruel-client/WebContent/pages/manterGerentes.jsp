                        ...
                        <div class="panel-body">
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-examples">
                                    ...
                                    <tbody>
                                        <c:forEach var="lstPessoa" items="${listaGerente}">
   		                                     <tr class="odd gradeX">
	                                            ...
	                                            <td class="center">
	                                            	<button type="button" class="btn btn-info btn-circle edit-pessoa gerente-edit"><i class="fa fa-edit"></i></button>
	                                            	<button type="button" class="btn btn-danger btn-circle delete-pessoa gerente-delete"><i class="fa fa-times"></i></button>
	                                            </td>
	                                        </tr>
                                       	</c:forEach>
                                    </tbody>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="Gerente?action=salva" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cpf" name="cpf" class="form-control cpf no-blank only-numeric" value="${gerente.cpf}">
                                            <p class="help-block">Apenas números. Ex.: 12345678910</p>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" for="endereco">Endereço</label>
                                            <input id="endereco" name="endereco" class="form-control no-blank" value="${gerente.endereco}">
                                            <p class="help-block">EndereÃ§o completo.</p>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" for="telefone">Telefone</label>
                                            <input id="telefone" name="telefone" class="form-control no-blank only-numeric" value="${gerente.telefone}">
                                            <p class="help-block">Apenas nÃºmeros. Ex.: 33123456</p>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" for="email">Email</label>
                                            <input id="email" name="email" class="form-control no-blank email" value="${gerente.email}">
                                        </div>
		                                <div class="form-group">
