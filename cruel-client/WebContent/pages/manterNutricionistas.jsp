                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
				            ...
				            <div class="row">
				                <div class="col-lg-6">
					                <form role="form" action="Nutricionista?action=search" method="POST">
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-examples">
                                    ...
                                    <tbody>
                                        <c:forEach var="lstPessoa" items="${listaNutricionista}">
   		                                     <tr class="odd gradeX">
	                                            ...
	                                            <td class="center">
	                                            	<button type="button" class="btn btn-info btn-circle edit-pessoa nutricionista-edit"><i class="fa fa-edit"></i></button>
	                                            	<button type="button" class="btn btn-danger btn-circle delete-pessoa nutricionista-delete"><i class="fa fa-times"></i></button>
	                                            </td>
	                                        </tr>
                                       	</c:forEach>
